    ...
    <nav class="top-nav">
      ...
      <div class="link" :class="{'open':menuOpen}">
        <div class="link-inner">
          ...
          <RouterLink to="/register">會員登入</RouterLink>
          <RouterLink class="go-order" to="/about">立即訂房</RouterLink>
        </div>
      </div>
    </nav>
    <div class="banner">
      ...
      <div class="banner-text">
        ...
        <div class="blur-wrap">
          <div class="blur-wrap-inner">
            ...
            <RouterLink class="go-to-order-btn" to="/about">立即訂房 ———————</RouterLink>
          </div>
        </div>
      </div>
    </div>
  ...
  .section-inner {
    ...
    .section-title {
      ...
      &:after {
        ...
        vertical-align: middle;
        width: 100px;
        background: rgb(191, 157, 125);
        background: linear-gradient(
          90deg,
          rgba(191, 157, 125, 1) 0%,
          rgba(191, 157, 125, 0) 100%
        );
        height: 2px;
      }
    }
...
.about-section {
  ...
  .text-wrap {
    ...
    background: linear-gradient(90deg, rgba(#140f0a, 0.8) 0%, rgba(#be9c7c, 0.8) 100%);
    padding: 40px;
    color: #fff;
    margin-bottom: -70px;
    .title {
